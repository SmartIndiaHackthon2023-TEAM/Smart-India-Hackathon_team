...
{
    let [smsValue , setSmsValue] = useState<{value : string | undefined}>();
    ...
    return (
        <>
            ...
            <CuMarq></CuMarq>
            <StaticNavBar/>
            <div id="small-fp-text"><p>Powered by Naive Bayes Classifier (:)</p></div>
            <div className="largeTextDiv" data-aos="fade-up">
                <p className="largeText" style={{marginRight : "8vh"}}>CHECK.`{`SMS`}`</p>
            </div>
                        ...
                        <div className="redUseBox">
                                ...
                                <div>
                                    <div className="redInput">
                                        <input type="text" placeholder="SMS here" name = "email" onChange={ (e) => {
                                            setSmsValue({value : e.target.value});
                                        }}/>
