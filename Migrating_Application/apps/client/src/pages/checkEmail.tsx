...
{
    let [emailValue , setEmailValue] = useState<{value : string} | undefined>();
    ...
    return (
        <>
            ...
            <CuMarq></CuMarq>
            <StaticNavBar/>
            <div id="small-fp-text"><p>Powered by Logistic Regression (:)</p></div>
            <div className="largeTextDiv" data-aos="fade-up">
                <p className="largeText" style={{marginRight : "8vh"}}>CHECK.EMAIL</p>
            </div>
